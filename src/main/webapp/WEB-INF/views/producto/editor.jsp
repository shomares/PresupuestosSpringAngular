...
<body ng-app="presupuestos" ng-controller="ctrlNuevoProducto">
	<nav>
			...
			<fieldset>
				...
				<p>
					<label>Nombre: </label><br> <input type="text"
						ng-model="producto.nombre" required autofocus>
				</p>
				<p>
					<label>Inventario Inicial </label><br> <input type="number"
						step="1.00" ng-model="producto.cantidadInventarioInicial" required
						autofocus
						class="validate"
						>
				</p>
				<p>
					<label>Inventario Final </label><br> <input type="number"
						step="1.00" ng-model="producto.cantidadInventarioFinal" required
						autofocus
						class="validate"
						>
				</p>
				<p>
					<label>Costo Inicial </label><br> <input type="number" class="validate"
						step="0.01" ng-model="producto.costoInicial" required autofocus>
				</p>

				<p>
					<label>Pronostico Ventas </label><br> <input type="number" class="validate"
						step="0.01" ng-model="producto.unidades" required autofocus>
				</p>

			</fieldset>
			<input type="submit" value="Enviar" ng-click="enviar"
				class="btn btn-info"><input type="reset"
				value="Limpiar" ng-click="enviar" class="btn btn-info">
