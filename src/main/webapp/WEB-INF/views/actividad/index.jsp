...
<body ng-app="presupuestos" ng-controller="ctrlEditarActividad">
	<nav>
		<div class="nav-wrapper blue darken-1">
			<a href="#!" class="brand-logo"> AccountLink JS</a> 
	...
	<	<br>
		<table ng-init="getAll()" class="bordered">
			...
			<tr ng-repeat="actividad in lista">
				<td>{{actividad.nombre}}</td>
				<td><a href="Actividad/Editar?id={{actividad.id}}">Editar</a></td>
				<td><a href="#" ng-click="eliminar({{actividad.id}})">Eliminar</a></td>
								<td><input type="checkbox" class="filled-in"
						id="filled-in-box{{actividad.id}}"
						ng-model="actividad.selected" /> <label
						for="filled-in-box{{actividad.id}}">Seleccionar</label></td>
