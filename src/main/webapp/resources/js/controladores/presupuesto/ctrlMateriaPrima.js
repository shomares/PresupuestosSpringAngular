...
app.controller('ctrlNuevoMateriaPrima', function($scope, $location) {
	var baseDatos = new DaoGeneral("MateriaPrima");
	var id;
...
app.controller('ctrlEditarMateriaPrima', function($scope) {
	var baseDatos = new DaoGeneral("MateriaPrima");
	...
	$scope.eliminar = function(idMateriaPrima) {
		alertify.confirm("Desea eliminar las materia prima", function() {
	...
	$scope.eliminarTodos = function() {
		...
		alertify.confirm("Desea eliminar las materias primas seleccionadas",
				function() {
	...
	$scope.nuevo = function() {
		window.location.href = "MateriaPrima/Editar";
	};
