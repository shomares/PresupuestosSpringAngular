...
app.controller('ctrlUsuarioNuevo', function($scope, $location) {
	var baseDatos = new DaoGeneral("Usuario");
	var id;
...
app.controller('ctrlUsuario', function($scope) {
	var baseDatos = new DaoGeneral("Usuario");
	...
	$scope.eliminarTodos = function() {
		...
		alertify.confirm("Desea eliminar los usuarios selecionados",
				function() {
